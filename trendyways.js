 ...
 */
var ti_mse = function (series1, series2)
{
 ...
 */
var ti_rmse = function (series1, series2)
{
 ...
 */
var ti_mae = function (series1, series2)
{
 ...
 */
var ti_bollinger = function (list, n, k, targetAttr) {
  targetAttr = valueIfUndef(targetAttr, ["c"])
  var movingAvg = ti_ma (list, n, targetAttr);
 ...
 */
var ti_ma = function (values, order, targetAttr, outputAttr) {
  targetAttr = valueIfUndef(targetAttr, ["c"]);
 ...
 */
var ti_ema = function (serie, period, targetAttr, newAttr) 
{
 ...
 */
var ti_wma = function (series, weights, targetAttr)
{
  targetAttr = valueIfUndef(targetAttr, ["c"])
 ...
 */
var ti_obv = function (closeList, volumeList)
{
  var result = [];
 ...
 */
var ti_vpt = function (closeList, volumeList)
{
  var result = [];
 ...
 *                  and hist series.
 */
var ti_macd = function (closeValues, targetAttr)
{
  targetAttr = valueIfUndef(targetAttr, ["c"])
  slow = 26;
  fast = 12;
  signal = 9;
  slowEMA = ti_ema (closeValues, slow, targetAttr, "slowema");
  fastEMA = ti_ema (closeValues, fast, targetAttr, "fastema");
  ...
  signalLine = ti_ema (macdLine.slice(25), signal, "macd"); // avoid first 25 (padding)
  for (var i = 0; i < 25; i++)
  {
 ...
 */
var ti_momentum = function(values, order)
{
 ...
 */
var ti_roc = function(values, order, targetAttr)
{
  rocN = function (chunk)
  {
...
module.exports = function () {
  ...
  this.ti_atr=ti_atr
  this.ti_roc=ti_roc
  this.ti_momentum=ti_momentum
  this.ti_macd=ti_macd

  this.ti_vpt=ti_vpt
  this.ti_obv=ti_obv

  this.ti_mse=ti_mse
  this.ti_rmse=ti_rmse
  this.ti_mae=ti_mae
  this.ti_bollinger=ti_bollinger
  this.ti_ma=ti_ma
  this.ti_ema=ti_ema
  this.ti_wma=ti_wma

  this.floorPivots=floorPivots
  this.tomDemarksPoints=tomDemarksPoints
  this.woodiesPoints=woodiesPoints
  this.camarillaPoints=camarillaPoints
  this.fibonacciRetrs=fibonacciRetrs
}
